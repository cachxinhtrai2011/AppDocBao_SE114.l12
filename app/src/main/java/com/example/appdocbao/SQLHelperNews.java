...
public class SQLHelperNews extends SQLiteOpenHelper{
    ...
    public SQLHelperNews(Context context) {
    ...
    public ArrayList<ItemNews> getAllNewAdvanced() {
        ArrayList<ItemNews> tinTucHistoryList = new ArrayList<>();
        ItemNews tinTucHistory;
        ...
        while (cursor.moveToNext()) {
            ...
            tinTucHistory = new ItemNews(title, img, cmt, pubDate);
