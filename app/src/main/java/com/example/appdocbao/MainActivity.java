...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, MyFragment.Data {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_history) {
            Intent intent = new Intent(MainActivity.this, WatchedNewsActivity.class);
            startActivity(intent);
        }

        if (id == R.id.nav_timkiem) {
            Intent intentTK = new Intent(MainActivity.this, SearchingActivity.class);
    ...
    @Override
    public void sendData(String link) {
        Intent intent = new Intent(getBaseContext(), NewsDetail.class);
    ...
    private class ReadRSS extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            for (int i=0; i<urls.size(); i++){
                ...
                Log.d("do dai", itemNews.size()+"");
                adapter.add(new MyFragment(itemNews),titles.get(i));
            }
